...
open class ImageSlideshowItem: UIScrollView, UIScrollViewDelegate {
    ...
    */
    init(image: InputSource, zoomEnabled: Bool) {
        ...
        let tapRecognizer = UITapGestureRecognizer(target: self, action: #selector(self.doubleTappedInImageSlideshow))
    ...
    func doubleTappedInImageSlideshow() {
        ...
        //print("i was double tapped, posting notification from ImageSlideshowItem.swift")
        
        NotificationCenter.default.post(name: Notification.Name(rawValue: "doubleTappedViaImageSlideshow"), object: self)
