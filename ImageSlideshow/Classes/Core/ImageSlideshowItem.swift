...
open class ImageSlideshowItem: UIScrollView, UIScrollViewDelegate {
    ...
    */
    init(image: InputSource, zoomEnabled: Bool) {
        ...
        let tapRecognizer = UITapGestureRecognizer(target: self, action: #selector(ImageSlideshowItem.doubleTappedInImageSlideshow))
    ...
    func doubleTappedInImageSlideshow() {
        ...
        NotificationCenter.default.post(name: Notification.Name(rawValue: "doubleTappedViaImageSlideshow"), object: nil)
